...
<div id="container">
    <header class="header white-bg">
        <div class="navbar-header">
            <!--logo start-->
            <a href="<?= Yii::$app->homeUrl ?>" class="logo" >LR<span>RU</span></a>
            <!--logo end-->

            <div class="horizontal-menu navbar-collapse"><?= MenuHelper::firstMenuLevel($firstMenu); ?></div>
            <div class="top-nav"><?= MenuHelper::rightMenu(); ?></div>
        </div>
    </header>
    <? $secondMenuData = MenuHelper::secondMenuLevel($firstMenu, $secondMenu); ?>
    <? if ($secondMenuData): ?>
    <header class="header2 navbar-inverse">
        <div class="navbar-header">
            <div class="horizontal-menu navbar-collapse" style="margin-left: 100px;"><?= $secondMenuData ?></div>
        </div>
    </header>
    <? endif; ?>
    <? $thirdMenuData = MenuHelper::thirdMenuLevel($secondMenu, $thirdMenu); ?>
    <? if ($thirdMenuData): ?>
    <header class="header3 navbar-inverse" style="background-color: #0E3E6A;">
        <div class="navbar-header">
            <div class="horizontal-menu navbar-collapse" style="margin-left: 100px;"><?= $thirdMenuData ?></div>
        </div>
    </header>
    <? endif; ?>
