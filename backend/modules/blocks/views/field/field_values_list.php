...
/* @var $rows \common\models\BlockFieldValuesList[] */
...
<div class="panel panel-info" style="margin-bottom: 0;">
    <div class="panel-heading">
        <div class="row">
            ...
            <div class="col-lg-4">
                <a id="field-values-list-add-btn" class="btn btn-info btn-xs pull-right" href="#" data-field_id="<?= $model->id ?>"><i class="fa fa-plus"></i></a>
    ...
    <div class="panel-body task-content" id="block-form-field-values-list-items">
        <ul id="sortable" class="task-list">
            <? foreach ($rows as $row) { echo BlockHelper::getBlockFieldValuesListItem($row); } ?>
        </ul>
    </div>
</div>
