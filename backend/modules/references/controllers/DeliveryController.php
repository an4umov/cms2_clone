...
class DeliveryController extends ReferencesController
{
    public function init()
    {
        parent::init();

        $this->setClass(ReferenceDelivery::class);
        ...
        $this->getView()->params['secondMenu'] = MenuHelper::SECOND_MENU_REFERENCES_DELIVERY;
    }
}
