...
/**
 * Handles the creation of table `tag_categories`.
 */
class m190412_113529_create_tag_categories_table extends Migration
{
    const TABLE_NAME = 'tag_categories';
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        $this->addColumn(self::TABLE_NAME, 'name', $this->string(60)->notNull()->defaultValue(""));
        ...
        $this->createIndex('tag_categories_NK1', self::TABLE_NAME, 'root');
        $this->createIndex('tag_categories_NK2', self::TABLE_NAME, 'lft');
        $this->createIndex('tag_categories_NK3', self::TABLE_NAME, 'rgt');
        $this->createIndex('tag_categories_NK4', self::TABLE_NAME, 'lvl');
        $this->createIndex('tag_categories_NK5', self::TABLE_NAME, 'active');
    }
    ...
    {
        $this->dropIndex('tag_categories_NK1', self::TABLE_NAME);
        $this->dropIndex('tag_categories_NK2', self::TABLE_NAME);
        $this->dropIndex('tag_categories_NK3', self::TABLE_NAME);
        $this->dropIndex('tag_categories_NK4', self::TABLE_NAME);
        $this->dropIndex('tag_categories_NK5', self::TABLE_NAME);
