...
/**
 * Class m181225_120033_alter_menu
 */
class m181225_120033_alter_menu extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->createIndex('menu_NK1', self::TABLE_NAME, 'root');
        $this->createIndex('menu_NK2', self::TABLE_NAME, 'lft');
        $this->createIndex('menu_NK3', self::TABLE_NAME, 'rgt');
        $this->createIndex('menu_NK4', self::TABLE_NAME, 'lvl');
        $this->createIndex('menu_NK5', self::TABLE_NAME, 'active');
    }
    ...
    public function safeDown()
    {
        ...
        $this->dropIndex('menu_NK1', self::TABLE_NAME);
        $this->dropIndex('menu_NK2', self::TABLE_NAME);
        $this->dropIndex('menu_NK3', self::TABLE_NAME);
        $this->dropIndex('menu_NK4', self::TABLE_NAME);
        $this->dropIndex('menu_NK5', self::TABLE_NAME);
    ...
    {
        echo "m181225_120033_alter_menu cannot be reverted.\n";
